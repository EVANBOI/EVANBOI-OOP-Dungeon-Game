...
public class LogicSwitchesTest {
    ...
    public void xorActivation() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_logicSwitchesTest_xorActivation", "c_logicSwitchesTest");
    ...
    @Test
    @DisplayName("Test placing logical bomb next in position such that logic is fulfilled")
    public void logicalBombPlacedDownOnActiveCurrents() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_logicSwitchesTest_logicalBomb", "c_logicSwitchesTest");
    ...
    @Test
    @DisplayName("Testing logical rules of moved bomb")
    public void movingLogicalBomb() throws InvalidActionException {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_logicSwitchesTest_movingLogicalBomb", "c_logicSwitchesTest");
        ...
        // place bomb in other position next to unactive currents
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(TestUtils.getInventory(res, "bomb").get(0).getId());
        assertEquals(1, TestUtils.getEntities(res, "bomb").size());
        ...
        // activate switch that would have activated bomb in prior position and assert bomb does not explode
        res = dmc.tick(Direction.UP);
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.LEFT);
        ...
        // activate correct switch and assert exploded
        res = dmc.tick(Direction.LEFT);
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.DOWN);
        res = dmc.tick(Direction.RIGHT);
